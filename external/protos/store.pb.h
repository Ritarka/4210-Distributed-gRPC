...
#ifndef GOOGLE_PROTOBUF_INCLUDED_protos_2fstore_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_protos_2fstore_2eproto_2epb_2eh
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_protos_2fstore_2eproto;
namespace store {
class ProductInfo;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::store::ProductInfo* Arena::CreateMaybeMessage<::store::ProductInfo>(Arena*);
template <>
::store::ProductQuery* Arena::CreateMaybeMessage<::store::ProductQuery>(Arena*);
template <>
::store::ProductReply* Arena::CreateMaybeMessage<::store::ProductReply>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class ProductReply final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::store::ProductInfo>& _internal_products() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::store::ProductInfo>* _internal_mutable_products();
  public:
...
class ProductInfo final :
 ...
 public:
  ...
  template <typename Arg_ = const std::string&, typename... Args_>
  void set_vendor_id(Arg_&& arg, Args_... args);
  std::string* mutable_vendor_id();
  PROTOBUF_NODISCARD std::string* release_vendor_id();
  void set_allocated_vendor_id(std::string* ptr);

  private:
  const std::string& _internal_vendor_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_vendor_id(
      const std::string& value);
...
inline PROTOBUF_ALWAYS_INLINE void ProductQuery::set_product_name(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void ProductQuery::set_allocated_product_name(std::string* value) {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::store::ProductInfo>&
ProductReply::_internal_products() const {
  return _impl_.products_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::store::ProductInfo>*
ProductReply::_internal_mutable_products() {
  return &_impl_.products_;
}
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void ProductInfo::set_vendor_id(Arg_&& arg,
                                                     Args_... args) {
  ;
  _impl_.vendor_id_.Set(static_cast<Arg_&&>(arg), args..., GetArenaForAllocation());
...
inline void ProductInfo::set_allocated_vendor_id(std::string* value) {
  _impl_.vendor_id_.SetAllocated(value, GetArenaForAllocation());
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_protos_2fstore_2eproto_2epb_2eh
