...
struct BidQueryDefaultTypeInternal {
  PROTOBUF_CONSTEXPR BidQueryDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 BidQueryDefaultTypeInternal _BidQuery_default_instance_;
template <typename>
...
struct BidReplyDefaultTypeInternal {
  PROTOBUF_CONSTEXPR BidReplyDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 BidReplyDefaultTypeInternal _BidReply_default_instance_;
}  // namespace vendor
static ::_pb::Metadata file_level_metadata_protos_2fvendor_2eproto[2];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_protos_2fvendor_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_protos_2fvendor_2eproto = nullptr;
const ::uint32_t TableStruct_protos_2fvendor_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::absl::once_flag descriptor_table_protos_2fvendor_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_protos_2fvendor_2eproto = {
    false,
    false,
    182,
    descriptor_table_protodef_protos_2fvendor_2eproto,
    "protos/vendor.proto",
    &descriptor_table_protos_2fvendor_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_protos_2fvendor_2eproto::offsets,
    file_level_metadata_protos_2fvendor_2eproto,
    file_level_enum_descriptors_protos_2fvendor_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_protos_2fvendor_2eproto(&descriptor_table_protos_2fvendor_2eproto);
namespace vendor {
// ===================================================================
...
inline void BidQuery::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
      decltype(_impl_.product_name_) {}
...
::uint8_t* BidQuery::_InternalSerialize(
  ...
  if (!this->_internal_product_name().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "vendor.BidQuery.product_name");
...
inline void BidReply::SharedCtor(::_pb::Arena* arena) {
  (void)arena;
  new (&_impl_) Impl_{
      decltype(_impl_.vendor_id_) {}
...
::uint8_t* BidReply::_InternalSerialize(
  ...
  if (!this->_internal_vendor_id().empty()) {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE, "vendor.BidReply.vendor_id");
